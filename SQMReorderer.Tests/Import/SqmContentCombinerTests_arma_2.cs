...
namespace SQMReorderer.Tests.Import
{
    ...
    public class SqmContentCombinerTests_arma_2
    {
        ...
        public void Mission_state_contents_are_null_if_not_set_in_arma_2_mission_state()
        {
            ...
            Assert.AreEqual(null, sqmContents.Mission.RandomSeed);
            Assert.IsEmpty(sqmContents.Mission.AddOns);
            Assert.IsEmpty(sqmContents.Mission.AddOnsAuto);
            Assert.IsNull(sqmContents.Mission.Intel);
            Assert.IsEmpty(sqmContents.Mission.Groups);
            Assert.IsEmpty(sqmContents.Mission.Vehicles);
            Assert.IsEmpty(sqmContents.Mission.Markers);
            Assert.IsEmpty(sqmContents.Mission.Sensors);
        }
        ...
        public void Sets_intel_to_correct_arma_2_values()
        {
            ...
            Assert.AreEqual("name", sqmContents.Mission.Intel.BriefingName);
            Assert.AreEqual("desc", sqmContents.Mission.Intel.BriefingDescription);
            Assert.AreEqual(10, sqmContents.Mission.Intel.StartWeather);
            Assert.AreEqual(11, sqmContents.Mission.Intel.ForecastWeather);
            Assert.AreEqual(1, sqmContents.Mission.Intel.Year);
            Assert.AreEqual(2, sqmContents.Mission.Intel.Month);
            Assert.AreEqual(3, sqmContents.Mission.Intel.Day);
            Assert.AreEqual(4, sqmContents.Mission.Intel.Hour);
            Assert.AreEqual(5, sqmContents.Mission.Intel.Minute);
        }
        ...
        public void Intel_contents_are_null_if_not_set_in_arma_2_intel()
        {
            ...
            Assert.IsNull(sqmContents.Mission.Intel.BriefingName);
            Assert.IsNull(sqmContents.Mission.Intel.BriefingDescription);
            Assert.IsNull(sqmContents.Mission.Intel.StartWeather);
            Assert.IsNull(sqmContents.Mission.Intel.ForecastWeather);
            Assert.IsNull(sqmContents.Mission.Intel.Year);
            Assert.IsNull(sqmContents.Mission.Intel.Month);
            Assert.IsNull(sqmContents.Mission.Intel.Day);
            Assert.IsNull(sqmContents.Mission.Intel.Hour);
            Assert.IsNull(sqmContents.Mission.Intel.Minute);
        }
